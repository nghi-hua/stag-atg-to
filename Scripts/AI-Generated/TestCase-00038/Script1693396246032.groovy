...
'step 5: At Page_overview click on hyperlink_team_project_test_reports_test_maintena --> navigate to Page_test-reports_test-maintenance_active'

testObj = findTestObject('Object Repository/Page_team_project_overview/hyperlink_team_project_test_reports_test_maintena')
...
testObj = findTestObject('Object Repository/Page_team_project_test-reports_test-maintenance_active/hyperlink_team_project_test_reports_test_maintena_1')
...
WebUI.verifyMatch(WebUI.getUrl(), '.*/team/.*/project/.*/test-reports/test-maintenance/active(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(testObj)

'step 7: Add visual checkpoint at Page_test-reports_test-maintenance_stale'
