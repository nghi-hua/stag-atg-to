...
'step 5: At Page_settings click on hyperlink_team_project_custom_fields --> navigate to Page_custom-fields'

testObj = findTestObject('Object Repository/Page_team_project_settings/hyperlink_team_project_custom_fields')
...
'step 6: At Page_custom-fields click on button_select_organization'

testObj = findTestObject('Object Repository/Page_team_project_custom-fields/button_select_organization')
...
WebUI.verifyMatch(WebUI.getUrl(), '.*/team/.*/project/.*/custom-fields(?:#.*)?(?:\\?.*)?$', true)
